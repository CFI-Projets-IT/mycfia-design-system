 ...
 * TODO: Remplacer par classes CSS '.main-collapsed' / '.main-expanded' dans Twig
 */
function toggleSidebar() {
    ...
    // CSS équivalent:
    // .main { margin-left: 260px; transition: margin-left 0.3s; }
    // .main.main-collapsed { margin-left: 70px; }
 ...
 * TODO: Gérer via Stimulus controller avec data-attributes
 */
export function restoreSidebarState() {
    ...
    if (isCollapsed) {
        ...
        // CSS équivalent: .main.main-collapsed { margin-left: 70px; }
