...
document.addEventListener("DOMContentLoaded", () => {
  ...
  try {
    ...
    // 26. Initialiser l'onboarding DAP Step 6 Preview (si step6_upload_preview)
    if (
      window.location.pathname.includes("step6_upload_preview") ||
      document.getElementById("onboardingWelcomeModalStep6Preview")
    ) {
      console.log("[main] Initialisation de l'onboarding DAP Step 6 Preview...");
      initOnboardingDAPStep6Preview();
    }

    // 27. Initialiser l'onboarding DAP Step 8 Validate (si step8_validate)
    if (
      window.location.pathname.includes("step8_validate") ||
      document.getElementById("onboardingWelcomeModalStep8Validate")
    ) {
    ...
    // 29. Initialiser l'onboarding DAP Campaign Show (si campaign_show)
    if (
      window.location.pathname.includes("campaign_show") ||
      document.getElementById("onboardingWelcomeModalCampaignShow")
    ) {
