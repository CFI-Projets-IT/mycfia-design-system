...
#[AsCommand(
    name: 'app:sync-campagnes',
    description: 'Synchronise les campagnes marketing depuis l\'API CFI (BDD Commune)',
)]
class SyncCampagnesCommand extends Command
{
    protected function execute(InputInterface $input, OutputInterface $output): int
    {
        ...
        $io->info('Objectif : Synchroniser les campagnes marketing depuis la BDD CFI Commune vers MyCFiA.');
