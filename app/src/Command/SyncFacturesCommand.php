...
#[AsCommand(
    name: 'app:sync-factures',
    description: 'Synchronise les factures depuis l\'API CFI (BDD Commune)',
)]
class SyncFacturesCommand extends Command
{
    protected function execute(InputInterface $input, OutputInterface $output): int
    {
        ...
        $io->info('Objectif : Synchroniser les factures depuis la BDD CFI Commune vers MyCFiA.');
